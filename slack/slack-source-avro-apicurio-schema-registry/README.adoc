...
> cp /home/workspace/miscellanea/slack-extended/target/slack-extended-0.10.0-package.tar.gz .
> untar.gz slack-extended-0.10.0-package.tar.gz
```
...
{"version":1,"createdOn":160.10.0208148,"type":"KCONNECT","globalId":1,"state":"ENABLED","id":"mytopic-value"}
```
...
{"createdOn":160.10.0208148,"modifiedOn":160.10.0208148,"id":"mytopic-value","version":1,"type":"KCONNECT","globalId":1,"state":"ENABLED"}
```
