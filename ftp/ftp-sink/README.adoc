...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-ftp-kafka-connector/0.7.2/camel-ftp-kafka-connector-0.7.2-package.zip
> unzip camel-ftp-kafka-connector-0.7.2-package.zip
----
