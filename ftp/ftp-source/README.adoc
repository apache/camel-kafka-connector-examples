...
9534a8d7a87c5f0525079824f692552fe6306fcea2e0e2a0fe60.10.138370a12
```

take note of the container id. In our case it is 9534a8d7a87c5f0525079824f692552fe6306fcea2e0e2a0fe60.10.138370a12
...
> cp /home/workspace/miscellanea/ftp-extended/target/ftp-extended-0.10.1-package.tar.gz .
> untar.gz ftp-extended-0.10.1-package.tar.gz
```
...
```
> docker exec -it 9534a8d7a87c5f0525079824f692552fe6306fcea2e0e2a0fe60.10.138370a12 bash
