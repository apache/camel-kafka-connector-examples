...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-aws2-kinesis-kafka-connector/0.10.0/camel-aws2-kinesis-kafka-connector-0.10.0-package.tar.gz
> untar.gz camel-aws2-kinesis-kafka-connector-0.10.0-package.tar.gz
```
    ...
    "Records": [
        {
            ...
            "SequenceNumber": "4961458467700449568901978308705626930.10.0414429070721026"
        }, 
        {
            "Data": "aGVsbG8gdGhlcmU=", 
            "PartitionKey": "partition-1", 
