...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-google-sheets-stream-kafka-connector/0.7.2/camel-google-sheets-stream-kafka-connector-0.7.2-package.zip
> unzip camel-google-sheets-stream-kafka-connector-0.7.2-package.zip
----
