...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-github-kafka-connector/0.7.0/camel-github-kafka-connector-0.7.0-package.zip
> unzip camel-github-kafka-connector-0.7.0-package.zip
----
