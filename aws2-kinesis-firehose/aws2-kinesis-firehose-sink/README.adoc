...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-aws2-kinesis-firehose-kafka-connector/0.7.2/camel-aws2-kinesis-firehose-kafka-connector-0.7.2-package.tar.gz
> untar.gz camel-aws2-kinesis-firehose-kafka-connector-0.7.2-package.tar.gz
```
