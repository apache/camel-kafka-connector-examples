...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-arangodb-kafka-connector/0.10.0/camel-arangodb-kafka-connector-0.10.0-package.tar.gz
> untar.gz camel-arangodb-kafka-connector-0.10.0-package.tar.gz
----
