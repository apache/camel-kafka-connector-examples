...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-cron-kafka-connector/0.10.1/camel-cron-kafka-connector-0.10.1-package.tar.gz
> untar.gz camel-cron-kafka-connector-0.10.1-package.tar.gz
----

In 0.10.1, you'll need to add also camel-quartz and quartz dependency.
