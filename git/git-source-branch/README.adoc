...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-git-kafka-connector/0.7.2/camel-git-kafka-connector-0.7.2-package.zip
> unzip camel-git-kafka-connector-0.7.2-package.zip
----
