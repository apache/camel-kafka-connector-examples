...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-git-kafka-connector/0.7.2/camel-git-kafka-connector-0.7.2-package.tar.gz
> untar.gz camel-git-kafka-connector-0.7.2-package.tar.gz
----
