...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-cql-kafka-connector/0.7.2/camel-cql-kafka-connector-0.7.2-package.tar.gz
> untar.gz camel-cql-kafka-connector-0.7.2-package.tar.gz
```
