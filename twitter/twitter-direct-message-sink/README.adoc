...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-twitter-directmessage-kafka-connector/0.7.2/camel-twitter-directmessage-kafka-connector-0.7.2-package.zip
> unzip camel-twitter-directmessage-kafka-connector-0.7.2-package.zip
```
