...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-twitter-timeline-kafka-connector/0.7.2/camel-twitter-timeline-kafka-connector-0.7.2-package.tar.gz
> untar.gz camel-twitter-timeline-kafka-connector-0.7.2-package.tar.gz
----
