...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-aws-s3-kafka-connector/0.10.1/camel-aws-s3-kafka-connector-0.10.1-package.tar.gz
> untar.gz camel-aws-s3-kafka-connector-0.10.1-package.tar.gz
```
