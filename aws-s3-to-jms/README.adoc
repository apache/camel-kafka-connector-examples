...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-sjms2-kafka-connector/0.7.2/camel-sjms2-kafka-connector-0.7.2-package.tar.gz
> untar.gz camel-sjms2-kafka-connector-0.7.2-package.tar.gz
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-aws-s3-kafka-connector/0.7.2/camel-aws-s3-kafka-connector-0.7.2-package.tar.gz
> untar.gz camel-aws-s3-kafka-connector-0.7.2-package.tar.gz
```
