...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-google-calendar-stream-kafka-connector/0.7.2/camel-google-calendar-stream-kafka-connector-0.7.2-package.zip
> unzip camel-google-calendar-stream-kafka-connector-0.7.2-package.zip
----
