...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-ftps-kafka-connector/0.7.2/camel-ftps-kafka-connector-0.7.2-package.zip
> unzip camel-ftps-kafka-connector-0.7.2-package.zip
----
