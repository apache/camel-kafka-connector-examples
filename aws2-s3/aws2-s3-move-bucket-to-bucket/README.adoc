...
> cd <ckc_project> 
> mvn clean package
> cp <ckc_project>/connectors/camel-aws2-s3-kafka-connector/target/camel-aws2-s3-kafka-connector-0.7.2-SNAPSHOT-package.tar.gz /home/oscerd/connectors/
> cd /home/oscerd/connectors/
> untar.gz camel-aws2-s3-kafka-connector-0.7.2-SNAPSHOT-package.tar.gz
```
