...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-file-kafka-connector/0.10.0/camel-file-kafka-connector-0.10.0-package.tar.gz
> untar.gz camel-file-kafka-connector-0.10.0-package.tar.gz
```
