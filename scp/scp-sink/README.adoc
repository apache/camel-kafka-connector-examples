...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-scp-kafka-connector/0.7.2/camel-scp-kafka-connector-0.7.2-package.tar.gz
> untar.gz camel-scp-kafka-connector-0.7.2-package.tar.gz
```
