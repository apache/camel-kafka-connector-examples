...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-scp-kafka-connector/0.7.2/camel-scp-kafka-connector-0.7.2-package.zip
> unzip camel-scp-kafka-connector-0.7.2-package.zip
```
