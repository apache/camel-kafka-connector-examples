...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-jdbc-kafka-connector/0.10.0/camel-jdbc-kafka-connector-0.10.0-package.tar.gz
> untar.gz camel-jdbc-kafka-connector-0.10.0-package.tar.gz
----
