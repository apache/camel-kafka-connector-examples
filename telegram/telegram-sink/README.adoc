...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-telegram-kafka-connector/0.7.2/camel-telegram-kafka-connector-0.7.2-package.zip
> unzip camel-telegram-kafka-connector-0.7.2-package.zip
```
