...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-pgevent-kafka-connector/0.7.2/camel-pgevent-kafka-connector-0.7.2-package.zip
> unzip camel-pgevent-kafka-connector-0.7.2-package.zip
----
