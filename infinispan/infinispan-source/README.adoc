...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-infinispan-kafka-connector/0.7.2/camel-infinispan-kafka-connector-0.7.2-package.tar.gz
> untar.gz camel-infinispan-kafka-connector-0.7.2-package.tar.gz
```
