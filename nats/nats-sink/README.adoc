...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-nats-kafka-connector/0.7.2/camel-nats-kafka-connector-0.7.2-package.tar.gz
> untar.gz camel-nats-kafka-connector-0.7.2-package.tar.gz
```
