...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-aws2-sqs-kafka-connector/0.3.0/camel-aws2-sqs-kafka-connector-0.3.0-package.zip
> unzip camel-aws2-sqs-kafka-connector-0.3.0-package.zip
```
