...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-google-mail-stream-kafka-connector/0.10.0/camel-google-mail-stream-kafka-connector-0.10.0-package.tar.gz
> untar.gz camel-google-mail-stream-kafka-connector-0.10.0-package.tar.gz
----
