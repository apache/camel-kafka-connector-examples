...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-amqp-kafka-connector/0.4.0/camel-amqp-kafka-connector-0.4.0-package.zip
> unzip camel-amqp-kafka-connector-0.4.0-package.zip
