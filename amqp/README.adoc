...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-amqp-kafka-connector/0.7.2/camel-amqp-kafka-connector-0.7.2-package.zip
> unzip camel-amqp-kafka-connector-0.7.2-package.zip
