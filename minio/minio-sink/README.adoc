...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-minio-kafka-connector/0.10.1/camel-minio-kafka-connector-0.10.1-package.tar.gz
> untar.gz camel-minio-kafka-connector-0.10.1-package.tar.gz
```
