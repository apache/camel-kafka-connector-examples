...
[source]
----
> echo "test" | ./kafkacat -b localhost:9092 -t mytopic -H "CamelHeader.username=andrea" -H "CamelHeader.city=Roma"
% Auto-selecting Producer mode (use -P or -C to override)
> echo "test" | ./kafkacat -b localhost:9092 -t mytopic -H "CamelHeader.username=John" -H "CamelHeader.city=New York"
% Auto-selecting Producer mode (use -P or -C to override)
----
