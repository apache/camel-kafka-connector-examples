...
> wget https://repo1.maven.org/maven2/org/apache/camel/kafkaconnector/camel-ssh-kafka-connector/0.7.2/camel-ssh-kafka-connector-0.7.2-package.tar.gz
> untar.gz camel-ssh-kafka-connector-0.7.2-package.tar.gz
```
